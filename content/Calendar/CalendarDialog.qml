...
{
    id: control
    width: (parent.width * 0.95 > 260) ? 260 : parent.width * 0.95
    ...
    property int selected_day: today.day
    property int selected_month: today.month
    property int selected_year: today.year
    ...
    Component.onCompleted: {
        footer.Material.foreground = Constants.accentColor
    }
    ...
    Item
    {
        ...
        Item
        {
            ...
            GridCombobox
            {
                ...
                delegate: ItemDelegate {
                    ...
                    Label
                    {
                        ...
                        text: model.number
                        color: (grid_combo.highlightedIndex === index) ? "white" : Constants.backgroundColor
                    }
                }
            ...
            Row
            {
                ...
                {
                    id: prev_btn
                    icon.source: "qrc:/content/images/left.svg"
                ...
                {
                    id: next_btn
                    icon.source: "qrc:/content/images/right.svg"
        ...
        C.DayOfWeekRow
        {
            ...
            delegate: Label {
                ...
                width: (days_of_week.width / 7) - 0.1
            }
        }
        ...
        ListView
        {
            ...
            delegate: MonthGrid {
                ...
                padding: 0
                cell_width: (container.width / 7) - 1
...
//                    radius: (width /2)
                    ...
                    Label
                    {
                        anchors.centerIn: parent
                        text: dataModel.day
                        color: (dataModel.selected) ? "white" : Constants.backgroundColor
                    }
